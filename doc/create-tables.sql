...
VALUES
    ('devices', 'Access to manage devices'),
    ('users', 'Access to manage users'),
    ('dashboard', 'Access to view the dashboard');
...
VALUES ('jperez', 'jperez@ceiot.lse', '$2b$10$apMib6tAp91D42jWTtx1ROBLF1xTvgS1Za8LaH0MOkMAODAdYOWeK', 'jose', 'perez', 1)